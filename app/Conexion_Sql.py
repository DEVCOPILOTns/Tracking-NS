...
key_path = r"C:\Users\amjimenez\OneDrive - NEW STETIC S.A\Documentos\Key_Encryptation(NO_BORRAR)\encryption.key"

# Ruta al archivo encriptado
encrypted_env_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "credentials.env.encrypted")
