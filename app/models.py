...
class OrderInfo:
    def __init__(self, guia: str, transportadora: str, cliente: str, 
                ...
                fecha_preparacion_pedido: str = '', estado_documento: str = '',
        ...
        self.fecha_preparacion_pedido = fecha_preparacion_pedido
    ...
    def from_dict(data: Dict[str, Any]) -> 'OrderInfo':
        info = OrderInfo(
            ...
            fecha_preparacion_pedido=data.get('fecha_preparacion_pedido') or data.get('Fecha Preparacion de pedido', ''),
